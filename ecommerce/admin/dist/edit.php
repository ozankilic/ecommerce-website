        ...
        <div class="container">
            <div class="row justify-content-center" style="margin-top:80px;">
                <?php 
                    ...
                    $productSql = "SELECT p.name, c.category_name, p.price, p.stock_code, i.src, pc.category_id FROM products p
                    INNER JOIN product_categories pc on pc.product_id = p.id
                    INNER JOIN images i on i.product_id = p.id
                    INNER JOIN categories c on pc.category_id = c.id
                    WHERE p.id = ".$productId;
                    $productQuery = mysqli_query($mysqli,$productSql);
                    ...
                    echo '<div class="col-5 offset-2">
                        ...
                        <input type="text" name="name" id="name" class="span3" value="'.$product['name'].'"> 
                        ...
                        <label>Price</label>
                        <input type="text" id="price" name="price" class="span3" value="'.$product['price'].'">
                        <label>Stock Code</label>
                        <input type="text" id="stock_code" name="stock_code" class="span3" value="'.$product['stock_code'].'">
                        <label>Image</label>
                        <input type="text" id="src" name="src" class="span3" value="'.$product['src'].'">
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(php_script_response){
                        $.ajax({
                        url: 'edit_product.php', // point to server-side PHP script 
                        data: {
                            productId: productId,
                            name: name,
                            category: category,
